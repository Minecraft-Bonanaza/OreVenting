...
ServerEvents.basicCommand('custom_vent', event => {
  ...
  if (hot.includes(biome)) {
    vents.push('§6Crimsite Vent§r (1/250)')
    vents.push('§4Scorchia Vent§r (1/250)')
  }
  if (cold.includes(biome)) {
    vents.push('§8Scoria Vent§r (1/200)')
  }
  if (mountain.includes(biome)) {
    vents.push('§eOchrum Vent§r (1/200)')
  }
  if (ocean.includes(biome)) {
    vents.push('§bAsurine Vent§r (1/300)')
    vents.push('§2Veridium Vent§r (1/300)')
  }
